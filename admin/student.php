                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="student.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter Name/ID of Student" class="span8" required>
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from LMS.user where (ID='$s' or Name like '%$s%') and ID<>'ADMIN'";
                                        }
                                    else
                                        $sql="select * from LMS.user where ID<>'ADMIN'";
