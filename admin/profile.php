                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <?php
                                $ID = $_SESSION['ID'];
                                $sql="select * from LMS.user where ID='$ID'";
                                ...
                                <form class="form-horizontal row-fluid" action="edit_admin_details.php?id=<?php echo $ID ?>" method="post">
...
$sql1="update LMS.user set Name='$name', EmailId='$email', MobNo='$mobno', Password='$pswd' where ID='$ID'";
