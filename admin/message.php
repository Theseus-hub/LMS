                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="message.php" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="ID"><b>Receiver ID:</b></label>
                                            <div class="controls">
                                                <input type="text" id="ID" name="ID" placeholder="ID" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
...
$sql1="insert into LMS.message (ID,Msg,Date,Time) values ('$ID','$message',curdate(),curtime())";
